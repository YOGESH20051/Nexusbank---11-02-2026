...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['plan_id'], $_POST['amount'])) {
    ...
    if (!$plan) {
        ...
        try {
            ...
            // 🧾 AUDIT — New investment
            logAdminAction($pdo, $_SESSION['user_id'], 'Investment', 'Started investment of ₹'.$amount);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['withdraw_investment_id'])) {
    ...
    if ($investment) {
        try {
            ...
            // 🧾 AUDIT — Investment withdrawal
            logAdminAction($pdo, $_SESSION['user_id'], 'Investment', 'Withdrew matured investment of ₹'.$totalReturn);
